...
def generate_launch_description():
        ...
        [
            ...
            PathJoinSubstitution(
                [
                    ...
                    "urdf",
                    "test_twelve_moteuses.urdf.xacro",
                ]
            )
        ]
    )
    ...
    diagnostic_broadcaster_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["diagnostic_broadcaster", "--controller-manager", "/controller_manager"],
    )
    ...
    delay_diagnostic_broadcaster_after_joint_state_broadcaster_spawner = RegisterEventHandler(
    ...
    nodes = [
        ...
        delay_diagnostic_broadcaster_after_joint_state_broadcaster_spawner,
    ]
